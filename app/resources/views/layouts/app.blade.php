...
<head>
    ...
    <title> @if(isset($title)) {{$title}} | CryptoNewsUpdate24 @else  CryptoNewsUpdate24 @endif</title>
    <!-- Scripts -->
    ...
    <nav class="navbar navbar-inverse navbar-sticky navbar-mobile bootsnav">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('index')}}"><p style="color:#fff; font-weight:bolder; margin-top:10px"> CryptoNewsUpdate<span style="font-size:25px; font-weight:bold; background:#d17c78; color:#fff; border-radius:5px">24</span> </p></a>
            </div>
